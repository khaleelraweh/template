...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $manageCollegeMenus = Permission::create(['name' => 'manage_college_menus', 'display_name' => ['ar'    =>  'إدارة الكليات و المعاهد', 'en'   =>  'Colleges and Institutes'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageWebMenus->id, 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '90',]);
        $manageCollegeMenus->parent_show = $manageCollegeMenus->id;
        $manageCollegeMenus->save();
        $showCollegeMenus    =  Permission::create(['name' => 'show_college_menus',  'display_name' => ['ar'    =>  ' إدارة الكليات و المعاهد',   'en'    =>  'Manage Colleges and Institutes'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '1', 'appear' => '1']);
