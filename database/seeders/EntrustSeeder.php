...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $manageCollegeMenus = Permission::create(['name' => 'manage_college_menus', 'display_name' => ['ar'    =>  'إدارة البرامج الأكاديمية', 'en'   =>  'Academic Programs'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageWebMenus->id, 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '90',]);
        // $manageCollegeMenus->parent_show = $manageCollegeMenus->id;
        // $manageCollegeMenus->save();
        // $showCollegeMenus    =  Permission::create(['name' => 'show_college_menus',  'display_name' => ['ar'    =>  ' إدارة البرامج الأكاديمية',   'en'    =>  'Manage Academic Programs'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '1', 'appear' => '1']);
        // $createCollegeMenus  =  Permission::create(['name' => 'create_college_menus', 'display_name'  => ['ar'  =>  ' إضافة برنامج اكاديمي',   'en'    =>  'Add Academic Program'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.create', 'icon' => null, 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        // $displayCollegeMenus =  Permission::create(['name' => 'display_college_menus', 'display_name'  => ['ar'  =>  'عرض برنامج اكاديمي',   'en'    =>  'Display Academic Program'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.show', 'icon' => null, 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        // $updateCollegeMenus  =  Permission::create(['name' => 'update_college_menus', 'display_name'  => ['ar'  =>  'تعديل برنامج اكاديمي',   'en'    =>  'Edit Academic Program'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.edit', 'icon' => null, 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        // $deleteCollegeMenus  =  Permission::create(['name' => 'delete_college_menus', 'display_name'  => ['ar'  =>  'حذف برنامج اكاديمي',   'en'    =>  'Delete Academic Program'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.destroy', 'icon' => null, 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '0', 'appear' => '0']);



        //Academic Programs menu AcademicProgramMenus
        $manageAcademicProgramMenus = Permission::create(['name' => 'manage_academic_program_menus', 'display_name' => ['ar'    =>  'إدارة البرامج الأكاديمية', 'en'   =>  'Academic Programs'], 'route' => 'academic_program_menus', 'module' => 'academic_program_menus', 'as' => 'academic_program_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageWebMenus->id, 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '90',]);
