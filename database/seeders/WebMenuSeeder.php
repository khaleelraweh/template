...
class WebMenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $about_instatute  = WebMenu::create(['title'  => ['ar' => 'عن الجامعة', 'en' => 'About University'], 'icon'   => 'fa fa-home', 'link' =>  ['ar' =>    'courses-list/تصميم', 'en'  =>    'courses-list/design'], 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => null]);
        WebMenu::create(['title'  => ['ar' => 'التعريف بالجامعة', 'en' => 'Introduction to the University'], 'icon'   => 'fa fa-home', 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => $about_instatute->id]);
